...
namespace epoching.fps
{
    public class Canvas_toast : MonoBehaviour
    {
        ...
        public void init(string str, float show_time = 1.5f)
        {
            ...
            text.GetComponent<Text>().fontSize = (int)(Screen.width / 1080f * 32);
            text.GetComponent<RectTransform>().sizeDelta = new Vector2(Screen.width, 34);
            text.GetComponent<Text>().text = str;

            //set the background and text position
            game_object_text.transform.localPosition = new Vector3(0, -Screen.height / 3, 0);
            game_object_bg.transform.localPosition = new Vector3(0, -Screen.height / 3, 0);
