...
namespace WarriorAnims
{
	public class WarriorController:SuperStateMachine
	{
		...
		public void Jump()
		{
			if (warrior == Warrior.Crossbow) { ikHands.SetIKOff(); }
		}
		...
		public void Land()
		{
			if (warrior == Warrior.Crossbow) { ikHands.BlendIK(true, 0.5f, 0.25f); }
		}
		...
		public void Death()
		{
			...
			if (warrior == Warrior.Crossbow || warrior == Warrior.TwoHanded) { ikHands.SetIKOff(); }
			isDead = true;
		}
		...
		public void Revive()
		{
			...
			isDead = false;
			if (warrior == Warrior.Crossbow || warrior == Warrior.TwoHanded) { ikHands.BlendIK(true, 1f, 0.25f); }
		}
		...
		public void AnimatorDebug()
		{
			...
			Debug.Log("Weapons: " + animator.GetBool("Weapons"));
